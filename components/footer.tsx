        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-saffron to-green mr-2">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <FooterLink href="#">Land Record Search</FooterLink>
              <FooterLink href="#">Dispute Filing</FooterLink>
              <FooterLink href="#">Record Verification</FooterLink>
              <FooterLink href="#">Property Mapping</FooterLink>
              <FooterLink href="#">Legal Assistance</FooterLink>
          ...
          <div id="contact-support">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+91 11 2306 2365</span>
              </li>
              <li className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
